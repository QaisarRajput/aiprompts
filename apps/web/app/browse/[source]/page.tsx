      ...
      <div className="space-y-6">
        <section className="rounded-2xl border border-border bg-surface p-5 shadow-card">
          ...
          <p className="mt-1 text-sm text-text-muted">
            {meta.counts.total} prompts, {meta.counts.featured} featured, {meta.taxonomy.length} categories
          </p>
        </section>
        ...
        >
          <BrowseGallery sourceId={sourceId} prompts={prompts} taxonomy={meta.taxonomy} />
        </Suspense>
      </div>
    );
  } catch {
